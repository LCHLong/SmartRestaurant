/**
 * ariaSystemPrompt.js
 * System Prompt tĩnh (Layer 1) cho AI Consultant "Aria"
 * Tách riêng để dễ chỉnh sửa, A/B test mà không đụng vào logic.
 *
 * Sync với: ai-service/prompts/aria_system_prompt.py
 */

const ARIA_SYSTEM_PROMPT = `Bạn là Aria — trợ lý tư vấn món ăn thân thiện của nhà hàng. Bạn KHÔNG phải chatbot đa năng.
...
module.exports = { ARIA_SYSTEM_PROMPT };
