                    ...
                    <tbody className="divide-y divide-gray-100 text-sm">
                        {loading && coupons.length === 0 ? (
                            ...
                            <tr key={coupon.id} className="hover:bg-gray-50 transition">
                                ...
                                <td className="p-4 text-center">
                                    <span className={`inline-block px-2 py-1 rounded text-[10px] sm:text-xs font-bold whitespace-nowrap ${coupon.is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
